...
Trust levels:
  - builtin:   Ships with Pilotage. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.pilotage/\.env|\~/\.pilotage/\.env',
     "pilotage_env_access", "critical", "exfiltration",
     "directly references Pilotage secrets file"),
    ...
    (r'\.pilotage/config\.yaml|\.pilotage/SOUL\.md',
     "pilotage_config_mod", "critical", "persistence",
     "references Pilotage configuration files directly"),
...
# scan. `.skillignore` is the Pilotage-native name; `.clawhubignore` is honored

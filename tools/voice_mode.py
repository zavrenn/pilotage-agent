...
def check_voice_requirements() -> Dict[str, Any]:
    ...
    native_stt_available = stt_provider == "openai"
    ...
    stt_available = stt_enabled and (native_stt_available or plugin_stt_available)
    ...
    if not stt_enabled:
        ...
        details_parts.append(
            "STT provider: MISSING (set VOICE_TOOLS_OPENAI_KEY or OPENAI_API_KEY)"
        )

"""Client for uploading ``pilotage debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``pilotage debug share``.
...
NAS_BASE = os.environ.get(
    "PILOTAGE_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "pilotage-agent/debug-share"

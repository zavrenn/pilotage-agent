"""
Pilotage CLI - Unified command-line interface for Pilotage Agent.

Provides subcommands for:
- pilotage chat          - Interactive chat (same as ./pilotage)
- pilotage gateway       - Run gateway in foreground
- pilotage gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    pilotage_cli/stdio.py::configure_windows_stdio() runs later from the entry

...
TIPS = [
    ...
    "pilotage plugins install owner/repo installs plugins directly from GitHub.",
    ...
    "pilotage auth add nous or pilotage auth add openai-codex sets up OAuth-based providers.",

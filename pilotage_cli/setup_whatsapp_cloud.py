...
Entry point: ``pilotage whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``pilotage_cli/main.py``).
...
Pilotage gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Pilotage to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Pilotage needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Pilotage gateway in another terminal:")
    print("         pilotage gateway")
    print()

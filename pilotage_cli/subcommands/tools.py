"""``pilotage tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'pilotage tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # pilotage tools list [--platform cli]
    ...
    # pilotage tools disable <name...> [--platform cli]
    ...
    # pilotage tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "setup. Keys: agent_browser, camofox, ddgs."
        ),
    )
    tools_postsetup_p.add_argument(
        "post_setup_key",
        metavar="KEY",
        help="Post-setup hook key (e.g. agent_browser, camofox, ddgs)",
    )

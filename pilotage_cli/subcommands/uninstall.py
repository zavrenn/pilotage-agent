"""``pilotage uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Pilotage Agent",
        description="Remove Pilotage Agent from your system. Can keep configs/data for reinstall.",
    )

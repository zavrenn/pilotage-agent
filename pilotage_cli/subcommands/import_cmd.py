"""``pilotage import`` subcommand parser.
...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Pilotage backup from a zip file",
        description="Extract a previously created Pilotage backup into your "
        "Pilotage home directory, restoring configuration, skills, "
        "sessions, and data",
    )

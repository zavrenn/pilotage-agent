...
from pilotage_cli.proxy.adapters.base import UpstreamAdapter
from pilotage_cli.proxy.adapters.nous_portal import NousPortalAdapter
from pilotage_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``pilotage proxy start --provider <name>`` CLI flag.

...
key tuples Pilotage already binds.
...
def install_shift_enter_alias() -> int:
    ...
    at the application layer — the sequences above never reach Pilotage.
...
def install_ctrl_enter_alias() -> int:
    ...
    falls through to the default character-insert handler. See.

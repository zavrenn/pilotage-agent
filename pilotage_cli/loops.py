...
Design notes / invariants (same contract as ``pilotage_cli/goals.py``):
...
- This module has zero hard dependency on ``cli.PilotageCLI``, the gateway
...
def _get_session_db() -> Optional[Any]:
    """One SessionDB per PILOTAGE_HOME (same pattern as goals._get_session_db)."""
    try:

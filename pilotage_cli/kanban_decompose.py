...
Invoked by ``pilotage kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Pilotage Agent board.
...
def _profile_author() -> str:
    """Mirror of ``pilotage_cli.kanban._profile_author``."""
    return (

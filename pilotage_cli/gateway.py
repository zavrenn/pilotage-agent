...
def get_python_path() -> str:
    ...
    if venv is not None:
        try:
            ...
            # Update-boundary: a gateway restarted after the checkout changed
            # can hold a pilotage_constants cached from before this symbol
            # existed. Re-execute the module from disk to pick it up.
            import importlib

            import pilotage_constants as _pc

            venv_python_path = importlib.reload(_pc).venv_python_path

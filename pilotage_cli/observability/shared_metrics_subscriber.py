"""Relay subscriber for the persisted Pilotage shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Pilotage counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        pilotage_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Pilotage shared metric: %s",
                    metric_name,
                    exc_info=True,
                )

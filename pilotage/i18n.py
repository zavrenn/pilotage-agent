...
_CATALOGS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "commands.description_effort": "Check or change this session's reasoning effort",
        "commands.effort_status": "Session effort: {effort}.\nAvailable: {options}.\nChange it with /effort {example}.",
        "commands.effort_set": "Session effort set to {effort} for the next request. An active request keeps its current effort.",
        "commands.effort_usage": "That effort is unavailable.\nAvailable: {options}.\nUse /effort to check, or /effort <level> to change it.",
        "commands.effort_failure": "I couldn't read or save the session effort. Please try /effort again.",
        "commands.effort_status_unavailable": "Session effort: {effort}.\nI couldn't check the available options. Please try /effort again.",
        "commands.effort_options_failure": "I couldn't check the available efforts. No changes were made. Please try /effort again.",
    ...
    "fr": {
        ...
        "commands.description_effort": "Consulter ou changer l’effort de raisonnement de cette session",
        "commands.effort_status": "Effort de la session : {effort}.\nDisponibles : {options}.\nPour changer : /effort {example}.",
        "commands.effort_set": "Effort de la session défini sur {effort} pour la prochaine demande. Une demande en cours conserve son effort actuel.",
        "commands.effort_usage": "Cet effort n’est pas disponible.\nDisponibles : {options}.\nUtilisez /effort pour consulter ou /effort <niveau> pour changer.",
        "commands.effort_failure": "Impossible de lire ou d’enregistrer l’effort de la session. Réessayez /effort.",
        "commands.effort_status_unavailable": "Effort de la session : {effort}.\nImpossible de vérifier les options disponibles. Réessayez /effort.",
        "commands.effort_options_failure": "Impossible de vérifier les efforts disponibles. Aucun changement n’a été effectué. Réessayez /effort.",
        "commands.alias": "alias : /{alias}",
    ...
    "ar": {
        ...
        "commands.description_effort": "عرض جهد التفكير لهذه الجلسة أو تغييره",
        "commands.effort_status": "جهد الجلسة: {effort}.\nالمتاح: {options}.\nللتغيير: /effort {example}.",
        "commands.effort_set": "تم ضبط جهد الجلسة على {effort} للطلب القادم. يحتفظ الطلب الجاري بجهده الحالي.",
        "commands.effort_usage": "هذا الجهد غير متاح.\nالمتاح: {options}.\nاستخدم /effort للعرض أو /effort <level> للتغيير.",
        "commands.effort_failure": "تعذّرت قراءة جهد الجلسة أو حفظه. حاول /effort مرة أخرى.",
        "commands.effort_status_unavailable": "جهد الجلسة: {effort}.\nتعذّر التحقّق من الخيارات المتاحة. حاول /effort مرة أخرى.",
        "commands.effort_options_failure": "تعذّر التحقّق من الجهود المتاحة. لم يتم إجراء أي تغيير. حاول /effort مرة أخرى.",

...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.pilotage-agent/\.env|\~/\.pilotage-agent/\.env', "pilotage_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.pilotage-agent/(config\.yaml|SOUL\.md)', "pilotage_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.pilotage-agent/.env``).  NOTE: this

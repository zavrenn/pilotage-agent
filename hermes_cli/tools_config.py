...
def _exempt_explicit_platform_native(
    ...
    the composite they chose (e.g. ``hermes-telegram``, which contains those
...
def _get_platform_tools(
    ...
    *,
    ...
    # ``hermes-telegram``) is an opt-in to the platform's native default-off
    ...
    if has_explicit_config:
        ...
        # ``[hermes-cli, video]`` after enabling Video Analysis via ``hermes

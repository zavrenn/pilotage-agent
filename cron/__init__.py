"""
Cron job scheduling system for Pilotage Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    pilotage gateway install    # Install as a user service
    sudo pilotage gateway install --system  # Linux servers: boot-time system service
    pilotage gateway            # Or run in foreground

...
See the ``pilotage-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Pilotage, e.g. 'pilotage-agent').\n"
    "  • Hub-installed skills (installed via 'pilotage skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'pilotage curator pin'). You are an "
    ...
    "'pilotage curator adopt <name>' — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'pilotage skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'pilotage curator pin'). Pin blocks "
    ...
    "reply and recommend 'pilotage curator adopt <name>' instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("PILOTAGE_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:

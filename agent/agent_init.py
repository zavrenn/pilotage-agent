...
def init_agent(
    ...
    # report cumulative micros spent.  Surfaced behind PILOTAGE_DEV_CREDITS.
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from pilotage_cli.config import load_config_readonly as _load_br_cfg
        ...
        if api_key and base_url:
            ...
            if base_url_host_matches(effective_base, "openrouter.ai"):
                ...
                client_kwargs["default_headers"] = pilotage_xai_default_headers()
    ...
    # worker (kanban_show tool is present iff PILOTAGE_KANBAN_TASK is set).
    ...
    if codex_app_server_auto_compaction not in {"native", "pilotage", "off"}:
        _ra().logger.warning(
            "Invalid compression.codex_app_server_auto=%r; using 'native'. "
            "Valid values are: native, pilotage, off.",

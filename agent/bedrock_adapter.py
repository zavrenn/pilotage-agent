"""AWS Bedrock Converse API adapter for Pilotage Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Pilotage with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Pilotage is installed editable into system Python, the system boto3

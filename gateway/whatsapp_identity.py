...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$PILOTAGE_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_pilotage_dir("platforms/whatsapp/session", "whatsapp/session")

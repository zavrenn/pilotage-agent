...
_GLOBAL_DEFAULTS: dict[str, Any] = {
    ...
    # text (an assistant status line). Values:
...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # Pilotage Cloud adapter doesn't implement edit_message yet, so we
...
def resolve_display_setting(
    ...
    platform_key : str
        Platform config key (e.g. ``"telegram"``, ``"whatsapp"``).  Use

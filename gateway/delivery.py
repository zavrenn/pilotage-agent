...
def resolve_delivery_transport(
    ...
    Preserves DeliveryRouter's historical support for explicitly supplied live
    adapters with no config block, while an explicitly disabled native adapter
    resolves to no transport.
    """

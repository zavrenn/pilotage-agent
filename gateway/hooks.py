...
Hooks are discovered from ~/.pilotage/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Pilotage session id
...
HOOKS_DIR = get_pilotage_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"pilotage_hook_{hook_name}"
